      ...
      <div class="row">
        <div class=" col-md-12 col-sm-12 page-content">
            ...
            @if(strlen($content->title) < 10)
              <div class="maint title-lines1" style="display:none">
            @else
              <div class="maint title-lines1 resetTopMargin" style="margin-top:-50px">
            @endif
            <div style="margin-top: 100px;">{!! ($content->title) !!}</div>
