		...
		<div class="container">
			...
			<div class="step-form row">
				<div class="col-md-10 col-md-offset-1">
					...
					<p>On a behalf of a class from school/guardian of a family</p> 
						<form method="GET" action="{{route('password.reset.verify.otp')}}">
							@csrf
						<input type="hidden" name="token" value="{{$token}}">
						<div class="row">

							<p>An OTP has been sent to your email address. Please enter the 4-digit code below to complete your password reset</p>
							
							<div class="form-group col-md-12 col-xs-12">
						      <input type="text" name="otp" class="form-control otpinput" placeholder="Enter OTP">
						    </div>
						    <div class="col-md-12 col-xs-12 alignoptbtn">
					    	<div class="form-group col-md-6 col-xs-12">
								<a href="{{route('resend.otp.password.reset',['token' => $token])}}" class="btn btn-warning" >Resend OTP</a>
							</div>
							<div class="form-group col-md-6 col-xs-12">
