		...
		<div class="container">
			...
			<div class="step-form row">
				<div class="col-md-10 col-md-offset-1">
					...
					<form method="POST" action="{{isset($route)? route($route) :route('password.reset.otp')}}" >
						@csrf
						<div class="row step1">

						    <div class="form-group col-md-12 col-xs-12">
						      <label for="email">Email:</label>
						      <input type="email" name="email" value="{{old('email')}}" class="form-control" required="" placeholder="Enter Username">
						      @error('email')
