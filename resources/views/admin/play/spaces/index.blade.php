      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Play Contents
              <a href="{{route('admin.play.spaces.add')}}" class="btn btn-sm btn-success">Add New</a>
            </h4>
          </div>
                  ...
                  @foreach($data as $space)
                    <tr>
                      ...
                      <td class="product-action" style="display: flex; align-items: center;">
                        <a href="{{route('admin.play.spaces.edit' ,$space->id)}}" style="margin-right: 10px;">
                        ...
                        <form
                          method="get"
                          action="{{route('admin.play.spaces.delete', $space->id)}}"
