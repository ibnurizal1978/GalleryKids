      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Hero Slider
              <a href="{{route('admin.kcae.hero-slides.create')}}" class="btn btn-sm btn-success">Add New</a>
            </h4>
          </div>
                  ...
                  @foreach($slides as $slide)
                    <tr>
                      ...
                      <td class="product-action" style="display: flex; align-items: center;">
                        <a
                          href="{{route('admin.kcae.hero-slides.edit' ,$slide->id)}}"
                        ...
                        <form
                          method="POST"
                          action="{{route('admin.kcae.hero-slides.destroy', $slide->id)}}"
