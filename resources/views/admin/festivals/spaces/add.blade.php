      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Add Space - Festivals</h4>
          </div>
          <div class="card-content">
            <div class="card-body">
              <form
                method="POST"
                action="{{route('admin.festivals.spaces.add')}}"
              ...
              >
                ...
                <div class="form-body">
                    ...
                    <div class="col-12">
                            <input type="submit" name="submit" class="btn btn-primary mr-1 mb-1" value="Submit" />
