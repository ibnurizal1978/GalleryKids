      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Festivals Categories
              <a href="{{route('admin.festivals.spaces.categories.add')}}" class="btn btn-sm btn-success">Add New</a>
            </h4>
          </div>
                  ...
                  @foreach($data as $category)
                    <tr>
                      ...
                      <td class="product-action" style="display: flex; align-items: center;">
                        <a
                          href="{{route('admin.festivals.spaces.categories.edit' ,$category->id)}}"
                        ...
                        <form
                          method="POST"
                          action="{{route('admin.festivals.spaces.categories.delete', $category->id)}}"
