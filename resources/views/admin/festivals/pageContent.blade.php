    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Festivals Main</h4>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form method="POST" action="{{route('admin.festivals.page-content')}}" enctype="multipart/form-data" class="form" id="kcae-content-form">
              @csrf
              <div class="form-body">
                <div class="row">

                @foreach($data as $pageContent)
                  <!-- Page Title -->
                  <div class="col-sm-12">
