      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Spaces Categories
              <a href="{{route('admin.kcae.spaces.categories.add')}}" class="btn btn-sm btn-success">Add New</a>
            </h4>
          </div>
                  ...
                  @foreach($categories as $category)
                    <tr>
                      ...
                      <td class="product-action" style="display: flex; align-items: center;">
                        <a
                          href="{{route('admin.kcae.spaces.categories.edit' ,$category->id)}}"
                        ...
                        <form
                          method="POST"
                          action="{{route('admin.kcae.spaces.categories.delete', $category->id)}}"
