				...
				<div class="col-md-10 col-md-offset-1">
					...
					<p>On a behalf of a class from school</p> 
						...
						<div class="row">
							...
							<p>An OTP has been sent to your email address. Please enter the 4-digit code below to complete your registration</p>
					    	...
					    	<div class="form-group col-md-6 col-xs-12">
								<a href="{{route('resend.otp',['token' => $token])}}" class="btn btn-warning" >Resend OTP</a>
							</div>
							<div class="form-group col-md-6 col-xs-12">
