...
class DownCommand extends BaseDownCommand
{
    ...
    protected $signature = 'down {--redirect= : The path that users should be redirected to}
                                 {--render=maintenance : The view that should be prerendered for display during maintenance mode}
    ...
    public function handle()
    {
        try {
            ...
            file_put_contents(
                ...
                file_get_contents( resource_path( 'stubs/maintenance-mode.stub' ) )
            );
    ...
    protected function getDownFilePayload()
    {
        return [
            ...
            'sub-directory' => $this->subDirectory(),
...
//        ( new RegisterErrorViewPaths )();
    ...
    /**
     * Get the sub-directory of the site
     */
