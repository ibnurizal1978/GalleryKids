      ...
      <div class="col-12">
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                      <form method="POST" action="{{route('event.store')}}" enctype="multipart/form-data" class="form">
                        @csrf
                          <div class="form-body">
                              <div class="row">
                                  ...
                                  <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="event-date-column" class="form-control datepicker" placeholder="Event Date" name="date">
                                  ...
                                  <div class="col-md-6 col-12">
                                    <fieldset class="form-group">
                                        <div class="custom-file">
                                            <input type="file" name="thumbnail" required="" class="custom-file-input" id="thumbnail" accept="image/*">
                                   ...
                                   <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="location-column" class="form-control" placeholder="Enter Location" name="location" required="">
