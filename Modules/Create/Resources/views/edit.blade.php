        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" action="{{route('create.update',$create->id)}}" enctype="multipart/form-data" class="form">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="title-column" class="form-control" value="{{$create->title}}" name="title" required="">
                                            <label for="title-column">Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="url" id="url-column" class="form-control" value="{{$create->url}}" name="url" required="">
                                            <label for="url-column">Url</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="content-start-date-column" class="form-control datepicker"  name="content_start_date" value="{{$create->content_start_date}}">
                                            <label for="content-start-date-column">Content Start Date</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="content-expiry-date-column" class="form-control datepicker" name="content_expiry_date" value="{{$create->content_expiry_date}}">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <select id="categories-column" name="category_id" class="form-control" required="">
                                                ...
                                                <option @if($category->id == $create->category_id) @endif value="{{$category->id}}">{{$category->name}}</option>
                                                @endforeach
                                            </select> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="custom-control custom-switch">
                                            ...
                                            <input type="checkbox" @if($create->members_only == 'Yes') checked @endif name="members_only" class="custom-control-input" id="members_only" value="Yes">
                                    ...
                                    <div class="col-12">
                                        <fieldset class="form-group">
                                            <textarea name="synopsis"  required="" class="form-control" id="basicTextarea" rows="3" placeholder="Synopsis">{{$create->synopsis}}</textarea>
                                        </fieldset>
                                    </div> 
