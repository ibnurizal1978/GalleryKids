      ...
      <div class="col-12">
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                      <form method="POST" action="{{route('create.store')}}" enctype="multipart/form-data" class="form">
                        @csrf
                          <div class="form-body">
                              <div class="row">
                                  <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="title-column" class="form-control" placeholder="Enter Title" name="title" value="{{old('title')}}" required="">
                                          <label for="title-column">Title</label>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="url" id="url-column" class="form-control" placeholder="Enter Url" name="url" value="{{old('url')}}" required="">
                                          <label for="url-column">Url</label>
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="content-start-date-column" class="form-control datepicker" placeholder="Content Start Date" name="content_start_date" value="{{old('content_start_date')}}">
                                          <label for="content-start-date-column">Content Start Date</label>
                                      </div>
                                  </div>
                                   <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="content-expiry-date-column" class="form-control datepicker" placeholder="Content Expiry Date" name="content_expiry_date" value="{{old('content_expiry_date')}}">
                                  ...
                                  <div class="col-md-6 col-12">
                                   ...
                                   <div class="col-md-6 col-12">
                                    <div class="custom-control custom-switch">
                                      ...
                                      <input type="checkbox" name="members_only" @if(!is_null(old('members_only')) && old('members_only') == 'Yes') checked="" @endif class="custom-control-input" id="members_only" value="Yes">
