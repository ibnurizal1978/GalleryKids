...
class Exhibition extends Model {
    ...
    protected $fillable = ['title', 'synopsis', 'url', 'content_start_date', 'content_expiry_date', 'members_only', 'category_id'];
    ...
    public function thumbnails() {
        return $this->hasMany('Modules\Exhibition\Entities\Thumbnail');
    }
