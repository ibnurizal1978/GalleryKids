      ...
      <div class="col-12">
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                      <form method="POST" action="{{route('festival.store')}}" enctype="multipart/form-data" class="form">
                        @csrf
                          <div class="form-body">
                              <div class="row">
                                  ...
                                  <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="content-start-date-column" class="form-control datepicker" placeholder="Content Start Date" name="content_start_date">
                                          <label for="content-start-date-column">Content Start Date</label>
                                      </div>
                                  </div>
                                   <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="content-expiry-date-column" class="form-control datepicker" placeholder="Content Expiry Date" name="content_expiry_date">
                                      ...
                                      <div class="form-label-group">
                                         <label for="targeted_age_group-column">Targeted Age Group</label>
                                          <select id="targeted_age_group-column" name="targeted_age_group" class="form-control" required="">
                                            ...
                                            <option value="Older than 15">Older than 15</option>
                                          </select> 
                                      </div>
                                  </div>
                                  <div class="col-md-6 col-12">
