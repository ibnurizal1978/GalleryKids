                                      ...
                                      <div class="form-label-group">
                                         <label for="type-column">Targeted Age Group</label>
                                          <select id="type-column" name="type" class="form-control" required="">
                                            ...
                                            <option @if($category->type == 'explore') selected="" @endif value="explore">Explore</option>
                                             <option @if($category->type == 'exhibition') selected="" @endif value="exhibition">Exhibition</option>
                                             <option @if($category->type == 'festival') selected="" @endif value="festival">Festival</option>
                                            <option @if($category->type == 'play') selected="" @endif value="play">Play</option> 
                                            <option @if($category->type == 'pictionShare') selected="" @endif value="pictionShare">pictionShare</option> 
                                          </select> 
                                      </div>
                                  </div>
