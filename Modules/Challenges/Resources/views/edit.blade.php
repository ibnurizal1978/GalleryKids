      ...
      <div class="col-12">
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                      <form method="POST" action="{{route('challenges.update',$challenge->id)}}" enctype="multipart/form-data" class="form">
                        @csrf
                          <div class="form-body">
                              <div class="row">
                                  ...
                                  <div class="col-md-6 col-12">
                                      <div class="form-label-group">
                                          <input type="text" id="name-column" class="form-control" value="{{$challenge->name}}" name="name" required="">
