...
@section('vendor-style')
        ...
        <link rel="stylesheet" href="{{ asset('admin/vendors/css/extensions/tether-theme-arrows.css') }}">
        <link rel="stylesheet" href="{{ asset('admin/vendors/css/extensions/tether.min.css') }}">
        <link rel="stylesheet" href="{{ asset('admin/vendors/css/extensions/shepherd-theme-default.css') }}">
@endsection
@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset('admin/css/pages/dashboard-analytics.css') }}">
        <link rel="stylesheet" href="{{ asset('admin/css/pages/card-analytics.css') }}">
        <link rel="stylesheet" href="{{ asset('admin/css/plugins/tour/tour.css') }}">
  @endsection
                      ...
                      <td class="p-1">
                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                          ...
                          data-original-title="Vinnie Mostowy" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-11.jpg')}}" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
